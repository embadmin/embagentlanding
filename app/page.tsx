      ...
      <section className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <div key={idx} className="flex flex-col items-center text-center bg-[#333] text-white rounded-xl p-6 min-h-[400px] shadow-md border border-white/10">
              <h3 className="text-xl font-anton font-bold mb-2 tracking-wide">{title}</h3>
              <p className="text-sm text-gray-300 mb-6 flex-1">{description}</p>
              <button onClick={onClick} className="transition-transform duration-200 hover:scale-105 focus:outline-none">
